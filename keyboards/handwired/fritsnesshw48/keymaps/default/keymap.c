 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |SftEtr|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | PWR  |Shift | Alt  | GUI  |Lower |Space |enter |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    LT(_SODA, KC_POWER), KC_LSFT , KC_LALT, KC_LGUI, MO(_LOWER), LT(_SPACE, KC_SPC), KC_ENT, MO(_RAISE), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_NUMPAD] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, KC_P0, KC_P0, KC_PDOT, KC_PCMM, KC_PEQL
),
